...
.md-column {
  color: rgba(0, 0, 0, 0.54); }
  .md-column md-icon.md-sort-icon {
    color: rgba(0, 0, 0, 0.38); }
  .md-column.md-active,
  .md-column.md-active md-icon {
    color: black; }
...
.md-row-select tbody.md-body > tr.md-row.md-selected {
  background-color: rgba(225, 245, 254, 0.12); }
...
table.md-table {
  ...
  table.md-table th.md-checkbox-column {
    ...
    table.md-table td.md-checkbox-cell md-checkbox /deep/ .md-checkbox-inner-container,
    table.md-table th.md-checkbox-column md-checkbox /deep/ .md-checkbox-inner-container {
      width: 18px;
      height: 18px;
      margin: 0; }
  table.md-table td.md-cell {
