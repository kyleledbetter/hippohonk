:host {
  ...
  :host /deep/ .td-chip {
    ...
    :host /deep/ .td-chip md-icon {
      ...
      :host /deep/ .td-chip md-icon:hover {
        cursor: pointer;
...
:host /deep/ md-input input::-webkit-calendar-picker-indicator {
  display: none; }

:host /deep/ md-input .md-input-underline {
  display: none; }
