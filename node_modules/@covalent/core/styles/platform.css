@font-face {
  ...
  /* For IE6-8 */
  src: local("font/Material Icons"), local("font/MaterialIcons-Regular"), url("font/MaterialIcons-Regular.woff2") format("woff2"), url("font/MaterialIcons-Regular.woff") format("woff"), url("font/MaterialIcons-Regular.ttf") format("truetype"); }
...
[md-button].md-icon-button {
  ...
  padding-right: 0;
  border-radius: 99%; }
  [md-button].md-icon-button:not(.md-icon-button-mini) {
    height: 48px;
    line-height: 48px;
    width: 48px; }
  [md-button].md-icon-button.md-icon-button-mini {
    height: 24px;
    line-height: 24px;
    width: 24px; }
  [md-button].md-icon-button, [md-button].md-icon-button > .md-button-wrapper {
...
body md-card {
  padding: 0;
  margin: 8px; }
  body md-card md-card-header {
    height: auto; }
  body md-card [md-card-avatar] {
    font-size: 40px;
    line-height: 40px;
    margin: 16px 0 0 15px; }
  body md-card [md-card-image] {
    width: 100%;
    margin: 0; }
  body md-card md-card-title {
    ...
    padding-left: 16px;
    padding-right: 16px; }
  body md-card md-card-subtitle {
    padding-left: 16px;
    padding-right: 16px; }
  body md-card md-card-content {
    padding: 16px; }
  body md-card md-card-actions:last-child, body md-card .md-card md-card-actions:last-child {
    padding: 8px;
    margin: 0; }
  body md-card form.md-card-search-box md-icon {
    width: 24px;
    color: #999;
    padding: 13px 0 0 12px; }
  body md-card form.md-card-search-box input {
    border: none;
    outline: 0; }
...
md-input.ng-invalid:not(.ng-pristine) label {
  color: #f44336; }

md-input.ng-invalid:not(.ng-pristine) .md-input-underline {
...
md-sidenav {
  ...
  md-sidenav .md-list-item md-icon {
    ...
    color: #737373;
    fill: #737373; }
  md-sidenav md-toolbar .md-toolbar-title {
    padding-top: 10px; }
  md-sidenav md-toolbar .md-toolbar-link {
    color: #444;
...
@media screen\0  and (min-width: 600px) and (max-width: 599px) {
  [flex-sm] {
    flex: 1 1 0%; } }
