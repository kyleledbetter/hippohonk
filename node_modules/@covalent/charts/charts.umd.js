    ...
    ChartComponent.prototype.drawChart = function () {
        ...
        if (this._data) {
            ...
            (function (ParseContent) {
                ParseContent[ParseContent["json"] = d3$1.json] = "json";
                ParseContent[ParseContent["csv"] = d3$1.csv] = "csv";
                ParseContent[ParseContent["tsv"] = d3$1.tsv] = "tsv";
...
var TdChartBarComponent = (function (_super) {
    ...
    function TdChartBarComponent(parent, _platformLocation) {
        ...
        this._colorPalette = [];
        this._mdBarColorPalette = ['#F8BBD0', '#f48fb1', '#ec407a', '#e91e63', '#d81b60',
    ...
    TdChartBarComponent = __decorate$1([
        ...
        __param$1(0, _angular_core.Inject(_angular_core.forwardRef(function () { return TdChartsComponent; }))), 
        __metadata$1('design:paramtypes', [TdChartsComponent, _angular_common.PlatformLocation])
    ], TdChartBarComponent);
...
var TdYLeftAxisComponent = (function () {
    ...
    TdYLeftAxisComponent = __decorate([
        ...
        __param(0, _angular_core.Inject(_angular_core.forwardRef(function () { return TdChartsComponent; }))), 
...
var TdChartsComponent = (function () {
    ...
    TdChartsComponent = __decorate([
        _angular_core.Component({
            selector: 'td-charts',
            styles: [":host /deep/ text { fill: rgba(0, 0, 0, 0.54); } :host /deep/ p { color: rgba(0, 0, 0, 0.54); } :host /deep/ .grid line { stroke: rgba(0, 0, 0, 0.12); } :host /deep/ .ticks line, :host /deep/ .ticks path { stroke: rgba(0, 0, 0, 0.12); } :host /deep/ .domain { stroke: rgba(0, 0, 0, 0.12); } :host { display: block; } :host /deep/ .grid path { stroke-width: 0; } :host /deep/ .axisTitle { font-size: 11px; font-weight: bold; } :host /deep/ .line { fill: none; stroke-width: 2px; } "],
...
var TdChartLineComponent = (function (_super) {
    ...
    function TdChartLineComponent(parent, _platformLocation) {
        ...
        this.transitionDuration = 0;
        this.transitionDelay = 0;
        this.colors = ['#304FFE', '#00B8D4', '#FF3D00'];
    ...
    TdChartLineComponent = __decorate$3([
        ...
        __param$2(0, _angular_core.Inject(_angular_core.forwardRef(function () { return TdChartsComponent; }))), 
        __metadata$3('design:paramtypes', [TdChartsComponent, _angular_common.PlatformLocation])
...
var TdChartAreaComponent = (function (_super) {
    ...
    TdChartAreaComponent = __decorate$4([
        ...
        __param$3(0, _angular_core.Inject(_angular_core.forwardRef(function () { return TdChartsComponent; }))), 
        __metadata$4('design:paramtypes', [TdChartsComponent, _angular_common.PlatformLocation])
...
var CovalentChartsModule = (function () {
    ...
    CovalentChartsModule = __decorate$2([
...
exports.TdChartsComponent = TdChartsComponent;
exports.TdXAxisComponent = TdXAxisComponent;
exports.TdYLeftAxisComponent = TdYLeftAxisComponent;
exports.TdYRightAxisComponent = TdYRightAxisComponent;
exports.CovalentChartsModule = CovalentChartsModule;
